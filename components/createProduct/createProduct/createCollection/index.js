  ...
  useEffect(() => {
    if (collectionUpdateEnabled) {
      ...
      if (collectionUpdateData) {
        ...
        setCollectionDescriptionTR(
          collectionUpdateData.collectionDescriptionTR
        );
        ...
        setCollectionDescriptionEN(
          collectionUpdateData.collectionDescriptionEN
        );

        setCollectionNameUA(collectionUpdateData.collectionNameUA);
        setCollectionTypeUA(collectionUpdateData.collectionTypeUA);
        setCollectionDescriptionUA(
          collectionUpdateData.collectionDescriptionUA
        );
      }
    ...
    <div className='w-full p-2'>
      ...
      <div className='w-full bg-gray-100 border-4 border-purple-600 p-2 lg:my-10 my-4 flex flex-col lg:flex-row flex-wrap gap-4 justify-center item-center rounded-md'>
        <div className='w-full flex justify-center items-center'>
          <h3 className='text-lg md:text-2xl font-bold bg-purple-600 p-4 rounded text-white'>{`${
            collectionUpdateEnabled && collectionUpdateData
        ...
        <div className='w-full flex justify-center item-center lg:items-end flex-col lg:flex-row flex-wrap gap-4'>
          ...
          <div className='flex flex-col justify-center items-center'>
            ...
            <div className='flex lg:flex-row gap-4 flex-col'>
              <div className='flex flex-col justify-center items-center '>
                ...
                <select
                  onChange={(e) => {
                    !addTypeEnabled && setCollectionType(e.target.value);
                  }}
                  type='select'
          ...
          {collectionImages && collectionImages.length > 0 && (
            <div
              className='bg-red-600 p-2 rounded-md hover:cursor-pointer hover:scale-110 transition-all'
          ...
          <div>
            {collectionImages && collectionImages.length > 0 && (
              <div
                className='bg-gray-600 p-2 rounded-md hover:cursor-pointer hover:scale-110 transition-all'
                onClick={() => {
                  collectionImages &&
                ...
                <div className='p-2 bg-white rounded-lg relative lg:pt-2 w-full lg:w-auto lg:mt-10 scale-90 lg:scale-100'>
                  ...
                  <div>
                    ...
                    <div className='w-full flex pl-1 justify-center item-center flex-row flex-nowrap gap-2'>
                      ...
                      <input
                        onChange={(e) =>
                          setCollectionDescriptionTR(e.target.value)
                        }
                  ...
                  <div>
                    ...
                    <div className='w-full flex pl-1 justify-center item-center flex-row flex-nowrap gap-2'>
                      ...
                      <input
                        onChange={(e) =>
                          setCollectionDescriptionUA(e.target.value)
                        }
        ...
        <div className='w-full flex justify-center items-center lg:mt-4'>
          ...
          >{`${
            collectionUpdateEnabled && collectionUpdateImageData
              ? 'Koleksiyonu Güncelle'
              : 'Koleksiyonu Oluştur'
          }`}</button>
        </div>
      ...
      {collectionProducts && (
        <div className='bg-gray-900 p-2 rounded inline-block'>
          <h3 className='text-white text-xl'>
            ...
            <span
              className={`${
                collectionProducts.length ? 'text-green-600' : 'text-red-600'
              } font-bold text-xl`}
            >
              {' '}
