...
const DynamicTable = ({
      ...
      Object.keys(responseData).forEach((item) => {
        responseData[item].forEach((item2) => {
          if (item == 'Ölçüler') {
            ...
            responseData[item] = responseData[item].sort(
              (a, b) =>
          ...
          if (item == 'Renkler') {
            ...
            responseData[item] = responseData[item].sort((a, b) =>
          ...
          if (item == 'Kumaşlar') {
            ...
            responseData[item] = responseData[item].sort((a, b) =>
              a.fabricSwatch.localeCompare(b.fabricSwatch)
            );
          }
  ...
  const sendData = async (
    ...
    const selectedCategoryKeyforCode = selectedCategoryKey
      .slice(0, 2)
      .toUpperCase();
    ...
    if (!newUpdateData) {
      productCode = (
        year +
        productNameFirst3Character +
        month +
        productTypeforCode +
        day +
        selectedCategoryKeyforCode +
        randomAlphabet
      ).trim();
    } else {
    ...
    try {
      if (newUpdateData) {
        const responseData = await postAPI('/createProduct/createProduct', {
          data: data,
          processType: 'update',
          productId: newUpdateData.createProducts.id,
        });
    ...
    key === 'image' && value && value.length > 0 ? (
      <div className='flex justify-center item-center'>
        <Image
          ...
          src={value}
          alt='Image'
          className='h-35 w-35 object-cover hover:scale-150 transition-all hover:border-2 border-gray-600 hover:rounded'
        />
      </div>
    ) : (
      value
    ...
    return (
      <div className='overflow-x-auto'>
        <table className='table w-full border-collapse border border-gray-300'>
          <thead>
            <tr>
              <th className='p-3 text-white bg-blue-600 font-bold border-l border-white'>
                Sıra
              </th>
              ...
              {filteredData[0] && Object.keys(filteredData[0]).map(
                (header) =>
                  ...
                  header != 'id' && (
                    <th
                      key={header}
                      className='p-3 text-white bg-blue-600 border-l border-white font-bold'
                    >
              ...
              >
                ...
                {Object.entries(item).map(([key, value]) =>
                  ...
                  ${
                    ...
                    checkboxValues.some(
                      (value) =>
                        value.feature.toLowerCase().includes('extra') &&
                        value.index === index &&
                        value.checked === true
                    )
                      ? 'bg-blue-100'
                    ...
                    >
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          const updatedCheckboxValues = checkboxValues.map(
                            (item) => {
                              if (
                  ...
                  ${
                    ...
                    checkboxValues.some(
                      (value) =>
                        value.feature.toLowerCase().includes('image') &&
                        value.index === index &&
                        value.checked === true
                    )
                      ? 'bg-blue-100'
                  ...
                  `}
                    ...
                    key != 'id' && (
                      <td
                        key={key}
                        className='p-3 border-t border-gray-300 border-l border-r text-center hover:bg-blue-100'
                      >
                        {key === 'colourHex' ? (
                          <div
  ...
  return (
    <div>
      ...
      <div className='w-full bg-gray-100 p-2 lg:my-10 my-4 flex flex-col lg:flex-row flex-wrap gap-4 justify-center item-center'>
        ...
        <div className='flex flex-col justify-center items-center'>
          ...
          <div className='flex lg:flex-row gap-4 flex-col'>
            <div className='flex flex-col justify-center items-center '>
              ...
              <select
                onChange={(e) => {
                  !addTypeEnabled && setProductType(e.target.value);
                }}
                type='select'
                  ...
                  productTypes.map(
                    (item, index) =>
                      ...
                      !productTypes
                        .slice(0, index)
                        .some(
                          (item2) => item2.productType === item.productType
                        ) && (
            ...
            <div className='flex flex-col justify-center items-center'>
              <div
                className={`flex justify-center items-center gap-2 flex-col lg:flex-row`}
              >
                <button
                  type='button'
                  onClick={() => {
                    setAddTypeEnabled(!addTypeEnabled);
                  }}
                >
                  {addTypeEnabled ? (
                    <div
                    ...
                    >
                      ...
                      <h4 className='whitespace-nowrap'>İptal</h4>
                    </div>
                  ) : (
                    <div className='hover:scale-105 transition-all p-2 bg-green-600 text-white rounded-md flex flex-row justify-center items-center gap-2'>
                      ...
                      <h4 className='whitespace-nowrap'>Ürün Tipi Ekle</h4>
                    </div>
                  )}
                </button>
        ...
        <div
          className='flex flex-col justify-end items-center hover:scale-110 transition-all hover:cursor-pointer'
              ...
              <div className='p-2 bg-white rounded-lg relative pt-10 lg:pt-2 flex justify-center items-center flex-col'>
                ...
                <div>
                  ...
                  <div className='flex flex-col gap-2 md:gap-2 justify-center items-center w-full '>
                    ...
                    {selectedCategoryValues &&
                      selectedCategoryValues.trim().length > 0 && (
                        <div className='bg-black p-1 w-full rounded-lg text-white mb-2'>
                          <h3 className='font-bold text-black bg-gray-200 inline-block p-2 rounded mr-2 min-w-[115px] text-end'>
                            Kategori :
                          </h3>
      ...
      productName.trim().length > 0 ? (
        ...
        <div className='w-full flex justify-center items-center p-2 '>
          <h3 className='text-center text-red-600'>
            Lütfen Önce{' '}
            <span className='text-red-600 font-bold'>Ürün Adını</span> ve{' '}
            <span className='text-red-600 font-bold'>Ürün Tipini</span> Giriniz.
          </h3>
        </div>
      )}
    </div>
