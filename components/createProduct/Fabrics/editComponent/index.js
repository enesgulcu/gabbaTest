      ...
      >
        <Formik
          ...
          onSubmit={async (value) => {
            setIsloading(true);
            const responseData = await postAPI('/createProduct/fabrics', {
              data: value,
              processType: 'update',
            });
            if (
              ...
              document.getElementById(
                `fabrics[${0}].fabricTypeUkrainian`
              ).value = '';
              document.getElementById(`fabrics[${0}].fabricTypeEnglish`).value =
                '';
              document.getElementById(
                `fabrics[${0}].fabricDescriptionTurkish`
              ).value = '';
              document.getElementById(
                `fabrics[${0}].fabricDescriptionUkrainian`
              ).value = '';
              document.getElementById(
                `fabrics[${0}].fabricDescriptionEnglish`
              ).value = '';
              document.getElementById(
                `fabrics[${0}].fabricSwatchTurkish`
              ).value = '';
              document.getElementById(
                `fabrics[${0}].fabricSwatchUkrainian`
              ).value = '';
              document.getElementById(
                `fabrics[${0}].fabricSwatchEnglish`
              ).value = '';
            }
          }}
        >
                              ...
                              <div className='flex flex-col justify-center items-center'>
                                ...
                                >
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      props.setFieldValue(
                                        `fabrics[${index}].addSwatchEnabled`,
                                        !props.values.fabrics[index]
                                          .addSwatchEnabled
                                      );
                                    }}
