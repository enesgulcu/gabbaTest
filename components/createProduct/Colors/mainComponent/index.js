                    ...
                    */}
                    <div className="mt-2 flex flex-row flex-wrap justify-center items-start gap-2">
                      {Object.keys(filteredData).map((key) => (
                        <div
                        style={{
                          backgroundColor: `${key === "colourHex" ? filteredData[key] : ""}`,
                        }}
                          key={key}
                          ...
                          ${key === "colourDescriptionTurkish" && "bg-orange-400 "}
                          ${key === "colourDescriptionUkrainian" &&" bg-orange-400"}
                          ${key === "colourDescriptionEnglish" && " bg-orange-400"}
                          `}
                        >
                          {key === "colourType" ||
        ...
        <Formik
          ...
          onSubmit={async (value) => {
            ...
            if (
              ...
              document.getElementById(`colors[${0}].colourPickerEnabled`).value ="";
