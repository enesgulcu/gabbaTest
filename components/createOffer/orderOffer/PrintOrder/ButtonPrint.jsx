...
const InvoiceJustButton = ({ data, lang, title }) => {
  ...
  return (
    <div className='flex flex-col h-fit overflow-auto gap-6 relative m-auto w-[29.7cm]'>
      <Button
        className="flex flex-1" variant="outline" type="button"
        onClick={handlePrint}
      >
        {title}
      </Button>

      <div ref={printRef} className='a4 overflow-y-auto hidden print:block'>
        {/* Header */}
...
export default InvoiceJustButton;